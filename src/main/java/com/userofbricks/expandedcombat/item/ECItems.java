...
public class ECItems
{
    ...
    public static final RegistryObject<Item> SHIELD_IRON_DR = ITEMS.register("shield_iron_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_IRON_M = ITEMS.register("shield_iron_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_GOLD_UL = ITEMS.register("shield_gold_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_GOLD_UR = ITEMS.register("shield_gold_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_GOLD_DL = ITEMS.register("shield_gold_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_GOLD_DR = ITEMS.register("shield_gold_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_GOLD_M = ITEMS.register("shield_gold_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_DIAMOND_UL = ITEMS.register("shield_diamond_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_DIAMOND_UR = ITEMS.register("shield_diamond_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_DIAMOND_DL = ITEMS.register("shield_diamond_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_DIAMOND_DR = ITEMS.register("shield_diamond_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_DIAMOND_M = ITEMS.register("shield_diamond_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NETHERITE_UL = ITEMS.register("shield_netherite_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NETHERITE_UR = ITEMS.register("shield_netherite_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NETHERITE_DL = ITEMS.register("shield_netherite_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NETHERITE_DR = ITEMS.register("shield_netherite_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NETHERITE_M = ITEMS.register("shield_netherite_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_EMPTY_UL = ITEMS.register("shield_empty_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_EMPTY_UR = ITEMS.register("shield_empty_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_EMPTY_DL = ITEMS.register("shield_empty_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_EMPTY_DR = ITEMS.register("shield_empty_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_EMPTY_M = ITEMS.register("shield_empty_m", () -> new ECShieldItem(0, (new Item.Properties())));

    public static final RegistryObject<Item> SHIELD_STEEL_UL = ITEMS.register("shield_steel_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEEL_UR = ITEMS.register("shield_steel_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEEL_DL = ITEMS.register("shield_steel_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEEL_DR = ITEMS.register("shield_steel_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEEL_M = ITEMS.register("shield_steel_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_BRONZE_UL = ITEMS.register("shield_bronze_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_BRONZE_UR = ITEMS.register("shield_bronze_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_BRONZE_DL = ITEMS.register("shield_bronze_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_BRONZE_DR = ITEMS.register("shield_bronze_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_BRONZE_M = ITEMS.register("shield_bronze_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_SILVER_UL = ITEMS.register("shield_silver_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_SILVER_UR = ITEMS.register("shield_silver_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_SILVER_DL = ITEMS.register("shield_silver_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_SILVER_DR = ITEMS.register("shield_silver_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_SILVER_M = ITEMS.register("shield_silver_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_LEAD_UL = ITEMS.register("shield_lead_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_LEAD_UR = ITEMS.register("shield_lead_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_LEAD_DL = ITEMS.register("shield_lead_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_LEAD_DR = ITEMS.register("shield_lead_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_LEAD_M = ITEMS.register("shield_lead_m", () -> new ECShieldItem(0, (new Item.Properties())));
    //Twilight Forest
    public static final RegistryObject<Item> SHIELD_NAGA_UL = ITEMS.register("shield_naga_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NAGA_UR = ITEMS.register("shield_naga_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NAGA_DL = ITEMS.register("shield_naga_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NAGA_DR = ITEMS.register("shield_naga_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_NAGA_M = ITEMS.register("shield_naga_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_IRONWOOD_UL = ITEMS.register("shield_ironwood_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_IRONWOOD_UR = ITEMS.register("shield_ironwood_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_IRONWOOD_DL = ITEMS.register("shield_ironwood_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_IRONWOOD_DR = ITEMS.register("shield_ironwood_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_IRONWOOD_M = ITEMS.register("shield_ironwood_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_FIERY_UL = ITEMS.register("shield_fiery_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_FIERY_UR = ITEMS.register("shield_fiery_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_FIERY_DL = ITEMS.register("shield_fiery_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_FIERY_DR = ITEMS.register("shield_fiery_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_FIERY_M = ITEMS.register("shield_fiery_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEELEAF_UL = ITEMS.register("shield_steeleaf_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEELEAF_UR = ITEMS.register("shield_steeleaf_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEELEAF_DL = ITEMS.register("shield_steeleaf_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEELEAF_DR = ITEMS.register("shield_steeleaf_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_STEELEAF_M = ITEMS.register("shield_steeleaf_m", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_KNIGHTLY_UL = ITEMS.register("shield_knightly_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_KNIGHTLY_UR = ITEMS.register("shield_knightly_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_KNIGHTLY_DL = ITEMS.register("shield_knightly_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_KNIGHTLY_DR = ITEMS.register("shield_knightly_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_KNIGHTLY_M = ITEMS.register("shield_knightly_m", () -> new ECShieldItem(0, (new Item.Properties())));
    //Enderite Pluss
    public static final RegistryObject<Item> SHIELD_ENDERITE_UL = ITEMS.register("shield_enderite_ul", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_ENDERITE_UR = ITEMS.register("shield_enderite_ur", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_ENDERITE_DL = ITEMS.register("shield_enderite_dl", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_ENDERITE_DR = ITEMS.register("shield_enderite_dr", () -> new ECShieldItem(0, (new Item.Properties())));
    public static final RegistryObject<Item> SHIELD_ENDERITE_M = ITEMS.register("shield_enderite_m", () -> new ECShieldItem(0, (new Item.Properties())));
