...
public class ECItems {
    ...
    public static final RegistryObject<Item> IRON_BOW = ITEMS.register("iron_bow", () -> new ECBowItem(3f, (new Item.Properties()).maxDamage(480).group(EC_GROUP)));
    ...
    public static final RegistryObject<Item> DIAMOND_BOW = ITEMS.register("diamond_bow", () -> new ECBowItem(4f, (new Item.Properties()).maxDamage(672).group(EC_GROUP)));
    public static final RegistryObject<Item> NETHERITE_BOW = ITEMS.register("netherite_bow", () -> new ECBowItem(5f, (new Item.Properties()).maxDamage(768).group(EC_GROUP).isImmuneToFire()));
