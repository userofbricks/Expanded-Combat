...
/*
public class ECShieldRecipe extends SpecialRecipe {

    public ECShieldRecipe(ResourceLocation idIn) {
        super(idIn);
    }
    ...
    public IRecipeSerializer<?> getSerializer() {
        return RecipeSerializerInit.EC_CRAFTING_SPECIAL_SHIELD.get();
    }
}
 */
