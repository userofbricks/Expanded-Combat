...
public class BowItemBuilder extends MaterialItemBuilder {
    public static RegistryEntry<? extends BowItem> generateBow(Registrate registrate, Material material, Material craftedFrom, NonNullTriFunction<Item.Properties, Material, Material, ? extends BowItem> bowConstructor, boolean generateRecipes) {
        String locationName = material.getLocationName().getPath();

        ItemBuilder<? extends BowItem, Registrate> itemBuilder = registrate.item(locationName + "_bow", (p) -> bowConstructor.apply(p, material, craftedFrom));
    ...
    public static RegistryEntry<? extends BowItem> generateHalfBow(Registrate registrate, Material material, Material craftedFrom, NonNullTriFunction<Item.Properties, Material, Material, ? extends BowItem> bowConstructor, boolean generateRecipes) {
        String locationName = material.getLocationName().getPath();

        ItemBuilder<? extends BowItem, Registrate> itemBuilder = registrate.item("half_" + locationName + "_bow", (p) -> bowConstructor.apply(p, material, craftedFrom));
    ...
    private static void genModel(ItemBuilder<? extends BowItem, Registrate> itemBuilder, String locationName, String prefix) {
