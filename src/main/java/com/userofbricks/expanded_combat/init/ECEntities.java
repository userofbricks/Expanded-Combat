...
public class ECEntities {
    ...
    public static final Supplier<EntityType<ECArrow>> EC_ARROW = ENTITIES.register("ec_arrow",
            (res) -> EntityType.Builder.<ECArrow>of(ECArrow::new, MobCategory.MISC)
                    .updateInterval(20)
                    .clientTrackingRange(4)
                    .sized(0.5f, 0.5f)
                    .build(ResourceKey.create(Registries.ENTITY_TYPE, res))
    );
    public static final Supplier<EntityType<ECFallingBlockEntity>> EC_FALLING_BLOCK = ENTITIES.register("ec_falling_block",
            (res) -> EntityType.Builder.<ECFallingBlockEntity>of(ECFallingBlockEntity::new, MobCategory.MISC)
                    .sized(0.98f, 0.98f)
