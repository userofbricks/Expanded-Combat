...
public class ItemGenerationTypes {
    ...
    public static final DeferredHolder<WeaponGenerator, WeaponGenerator> ARROW_BLOCKING_WEAPON = WEAPON_GENERATORS.register("arrow_blocking", () -> new WeaponGenerator((material, weapon, properties) -> new ArrowBlockWeaponItem(material, weapon, properties, 2)));
}
