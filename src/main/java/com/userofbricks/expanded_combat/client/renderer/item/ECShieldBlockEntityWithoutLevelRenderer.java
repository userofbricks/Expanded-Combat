    ...
    public void renderByItem(ItemStack stack, ItemDisplayContext transformType, PoseStack poseStack, MultiBufferSource multiBufferSource, int combinedLight, int combinedOverlay) {
        if(!stack.isEmpty()) {
            ...
            if(mc.player != null) {
                ...
                ECBaseShieldModel upperLeft = new ECBaseShieldModel(mc.getEntityModels().bakeLayer(ECLayerDefinitions.SHIELD_UPPER_LEFT));
                ECBaseShieldModel upperRight = new ECBaseShieldModel(mc.getEntityModels().bakeLayer(ECLayerDefinitions.SHIELD_UPPER_RIGHT));
                ECBaseShieldModel lowerLeft = new ECBaseShieldModel(mc.getEntityModels().bakeLayer(ECLayerDefinitions.SHIELD_LOWER_LEFT));
                ECBaseShieldModel lowerRight = new ECBaseShieldModel(mc.getEntityModels().bakeLayer(ECLayerDefinitions.SHIELD_LOWER_RIGHT));
                ECBaseShieldModel middle = new ECBaseShieldModel(mc.getEntityModels().bakeLayer(ECLayerDefinitions.SHIELD_MIDDLE));
