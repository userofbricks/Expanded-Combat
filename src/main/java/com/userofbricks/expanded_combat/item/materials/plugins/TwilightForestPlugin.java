...
public class TwilightForestPlugin implements IExpandedCombatPlugin {
    ...
    public void registerMaterials(RegistrationHandler registrationHandler) {
        IRONWOOD =   registrationHandler.registerMaterial(new Material.Builder("Ironwood",    null, CONFIG.ironwood).gauntlet().shield().weapons());
        FIERY =      registrationHandler.registerMaterial(new Material.Builder("Fiery",       null, CONFIG.fiery).gauntlet().shield().weapons());
        STEELEAF =   registrationHandler.registerMaterial(new Material.Builder("Steeleaf",    null, CONFIG.steeleaf).gauntlet().shield().weapons());
        KNIGHTMETAL =registrationHandler.registerMaterial(new Material.Builder("Knight Metal",null, CONFIG.knightmetal).gauntlet().shield().weapons());
        NAGASCALE =  registrationHandler.registerMaterial(new Material.Builder("Naga Scale",  null, CONFIG.nagaScale).gauntlet().shield());
        YETI =       registrationHandler.registerMaterial(new Material.Builder("Yeti",        null, CONFIG.yeti).gauntlet());
        ARCTIC =     registrationHandler.registerMaterial(new Material.Builder("Arctic",      null, CONFIG.arctic).gauntlet());
    }
