...
public interface IMaterialItem extends IMendingBonusItem, IItemExtension, IComplexRepairItem {
    ...
    default boolean isValidRepairItem(ItemStack repair, ItemStack toRepair, boolean previousRetern) {
        return getMaterial().repairItem() != null && getMaterial().repairItem().get().test(repair);
    }
    ...
    @OnlyIn(Dist.CLIENT)
    default void appendHoverText(ItemStack stack, Item.TooltipContext context, List<Component> list, TooltipFlag pTooltipFlag) {
