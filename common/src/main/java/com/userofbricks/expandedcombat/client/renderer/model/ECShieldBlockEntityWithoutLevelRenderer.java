    ...
    public void renderByItem(ItemStack stack, ItemTransforms.TransformType transformType, PoseStack matrixStack, MultiBufferSource iRenderTypeBuffer, int combinedLight, int combinedOverlay) {
        if (!stack.isEmpty()) {
            ...
            if (mc.player != null) {
                ...
                ItemStack ul = new ItemStack(Registry.ITEM.get(new ResourceLocation(ExpandedCombat.MOD_ID, "shield_" + sul + "_ul")));
                ItemStack ur = new ItemStack(Registry.ITEM.get(new ResourceLocation(ExpandedCombat.MOD_ID, "shield_" + sur + "_ur")));
                ItemStack dl = new ItemStack(Registry.ITEM.get(new ResourceLocation(ExpandedCombat.MOD_ID, "shield_" + sdl + "_dl")));
                ItemStack dr = new ItemStack(Registry.ITEM.get(new ResourceLocation(ExpandedCombat.MOD_ID, "shield_" + sdr + "_dr")));
                ItemStack m =  new ItemStack(Registry.ITEM.get(new ResourceLocation(ExpandedCombat.MOD_ID, "shield_" + sm  + "_m" )));
                if (stack.hasFoil()) {
