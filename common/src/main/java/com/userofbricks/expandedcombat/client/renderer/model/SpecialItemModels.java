...
{
    /* TODO repalce this with a mixin just like ECShieldBlockEntityWithoutLevelRenderer
    ...
    public static void detectSpecials() {
        ...
        for ( RegistrySupplier<Item> ro : ECItems.ITEMS.getEntries()) {
             Item item = ro.get();
             ResourceLocation handheldModel = new ResourceLocation("expanded_combat", "models/item/" + item.toString() + "_handheld.json");
