...
public class ECPotionWeaponRecipe extends CustomRecipe
{
    public ECPotionWeaponRecipe(final ResourceLocation id) {
        super(id);
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return ECRecipeSerializers.EC_POTION_WEAPON_SERIALIZER.get();
    }
}
