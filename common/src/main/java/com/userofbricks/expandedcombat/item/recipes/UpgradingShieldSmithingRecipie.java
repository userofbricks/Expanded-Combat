...
public class UpgradingShieldSmithingRecipie extends ShieldSmithingRecipie {
    ...
    public RecipeSerializer<?> getSerializer() {
        return ECRecipeSerializers.EC_UPGRADING_SHIELD_SERIALIZER.get();
    }
    ...
    public static class Serializer extends AbstractRecipeSerializer<UpgradingShieldSmithingRecipie> {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, UpgradingShieldSmithingRecipie recipe) {
        }
    }
}
