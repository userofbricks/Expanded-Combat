...
public class ShieldSmithingRecipie implements Recipe<Container> {
    public static final ResourceLocation SHIELD_RECIPE_ID = new ResourceLocation(ExpandedCombat.MOD_ID, "ec_shields");
    ...
    public RecipeSerializer<?> getSerializer() {
        return ECRecipeSerializers.EC_SHIELD_SERIALIZER.get();
    }
    ...
    public static class Serializer extends AbstractRecipeSerializer<ShieldSmithingRecipie> {
