...
public class FlechingTableContainer extends ItemCombinerMenu {
    ...
    public FlechingTableContainer(int p_i231591_1_, Inventory p_i231591_2_, ContainerLevelAccess p_i231591_3_) {
        ...
        this.recipes = this.level.getRecipeManager().getAllRecipesFor(ECRecipeSerializers.FLETCHING_TYPE);
    }
    ...
    public FlechingTableContainer(int i, Inventory inventory) {
    ...
    public void createResult() {
        List<IFletchingRecipe> list = this.level.getRecipeManager().getRecipesFor(ECRecipeSerializers.FLETCHING_TYPE, this.inputSlots, this.level);
        if (list.isEmpty()) {
