...
public abstract class AbstractArrowEntityMixin {
    ...
    public void playerTouch(Player p_70100_1_) {
        if (!((AbstractArrow)(Object)this).level.isClientSide && (this.inGround || ((AbstractArrow)(Object)this).isNoPhysics()) && ((AbstractArrow)(Object)this).shakeTime <= 0) {
            boolean flag;
            ItemStack arrowStack = CuriosApi.getCuriosHelper().findEquippedCurio(ExpandedCombatForge.arrow_predicate, p_70100_1_)
                    .map(stringIntegerItemStackImmutableTriple -> stringIntegerItemStackImmutableTriple.right).orElse(ItemStack.EMPTY);
            ItemStack quiverStack = CuriosApi.getCuriosHelper().findEquippedCurio(ExpandedCombatForge.quiver_predicate, p_70100_1_)
                    .map(stringIntegerItemStackImmutableTriple -> stringIntegerItemStackImmutableTriple.right).orElse(ItemStack.EMPTY);
            ...
            flag = ((AbstractArrow)(Object)this).pickup == AbstractArrow.Pickup.ALLOWED ||
                    ...
                    Objects.requireNonNull(((AbstractArrow) (Object) this).getOwner()).getUUID() == p_70100_1_.getUUID();
